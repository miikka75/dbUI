...
// Exports T so seed-demo.js can reuse the same map (one source of truth).
...
module.exports = { T, seedTranslations };
if (require.main === module) {
  seedTranslations()
    .then(n => console.log('Seeded ' + n + ' demo translations into "en".'))

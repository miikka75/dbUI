...
// The lifter lives in ./app-core-fn.js — it is shared with the archive-write-store suite, which lifts
// the row-write members the same way.
const { runAppCore } = require('./app-core-fn');

...
backend = {
  ...
  getListAvatars: (folderId) => _post('getListAvatars', { folderId }),                                   // viewer-safe value->picture
  getListUserLinks: (folderId) => _post('getListUserLinks', { folderId }),                               // admin-only value->email
  setListUser: (folderId, listName, value, email) => _post('setListUser', { folderId, listName, value, email }),

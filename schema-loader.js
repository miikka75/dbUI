...
function validateSchema() {
  ...
  for (var v in VIEWS) {
    ...
    // `feed` publishes a view's .ics at a world-readable URL, and what may be published depends on
    // WHICH kind of feed it is — a shared file refuses `@me`, a per-person one requires it on every
